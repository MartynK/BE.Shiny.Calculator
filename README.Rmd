...
The goal of this project is to build a small Shiny application which aids in the sample size calculation for BE studies and to extract the information for ISCV from reported confidence limits.
